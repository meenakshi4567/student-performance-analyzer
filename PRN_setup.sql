...
('Blair Waldorf',            'CSE', 88.0, 3),
('Serena Van Der Woodsen',   'CST', 95.5, 4);

INSERT INTO students (name, department, marks) VALUES
('Andrea Sachs',       'CSE', 72.0),
('Emily Charlton',     'CST', 61.5),
('Nigel Kippling',     'ECE', 45.0),
('Amari Gupta',        'ECE', 55.0),
('Cher Williams',      'CSE', 91.0),
('Charlotte Woodsen',  'CST', 38.0),
('Lillianna Rossa',    'ECE', 82.5);
